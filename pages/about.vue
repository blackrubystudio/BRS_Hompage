    ...
    return{
      ...
      study:{
        ...
        desc:"<p>특기가 각기 다른 팀원들이</span><br>\
                 ...
                 2017년 2월부터 매주 1회 진행하고 있습니다</span><br>\
              </p>",
      ...
      python:{
        ...
        desc: "<p>블랙루비 주관의 '재미그래밍'프로그램은</span><br>\
                  ...
                  재미그래밍 / <a href='https://fungramming.github.io/class-list/' target='_blank'>https://fungramming.github.io/class-list/</a></span><br>\
                </p>",
        src: require("@/assets/img/background/background_1.png"),
        alt: "블랙루비 파이썬 클래스 사진"
      },
      ...
      weekly:{
        ...
        desc: "<p>회사의 상황을 전체 공유하고자 하는 목적으로</span><br>\
                  ...
                  매주 주간동향이라는 이름으로 팀별 진행상황을 발표하고</span><br>\
